  ...
  return (
    <main className="fixed inset-0 w-full h-full bg-[#367230]">
      ...
      <div className="absolute top-20 md:top-24 left-2 md:left-4 z-10">
        <div className="bg-white rounded-xl shadow-lg p-3 md:p-6 border border-gray-100 w-auto md:w-64">
          {/* Two columns on mobile, single column on desktop */}
          <div className="flex flex-row md:flex-col gap-2 md:gap-4">
            {/* Left Column - Post a Donation, Filter, Toggle */}
            ...
            {/* Right Column - Radius and In Range */}
            <div className="flex flex-col gap-2 md:gap-4 flex-shrink-0">
